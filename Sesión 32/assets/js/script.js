...
class Person {
    constructor(firstName, lastName, age, height, weight, id) {
...
let person1 = new Person("Dominick", "Perales", 9, 1.3, 50);
console.log(person1)
console.log(person1.lastName);
console.log(person1.height);

console.log("RETO 1");
let person2 = new Person("Ashley", "Perales", 19, 1.60, 54, 71156173);
console.log(person2)
